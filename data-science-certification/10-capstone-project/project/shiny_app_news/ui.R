...
shinyUI(fluidPage(  
    ...
    h3("News Style", style = "color:Plum"),
    h4("Instructions"),
    p("1. Please, wait until the three bottoms appear above the purple text area before starting to write."),
    ...
    fluidRow(column(12, tags$textarea(id="sentence", rows="5", cols="50", 
                            style = "background-color:Plum"), offset = 1))    
))
