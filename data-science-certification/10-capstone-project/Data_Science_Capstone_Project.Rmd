...
The histograms below show the distribution of sentence length measured in number of characters and in number of words for the three files. The distribution are completely different as expected: shorter sentences with few words for Twitter, longer sentences with more words for the news and the blogs.
